...
public class LoadMoreGridView extends GridView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		int headerHeight = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 75, dMetrics);
		int width = dMetrics.widthPixels / 2;
		int height = (dMetrics.heightPixels - headerHeight) / 3;
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mOnLoadMoreListener != null) {
			...
			Log.d("ThuNguyen", "First visible item: " + firstVisibleItem);
			Log.d("ThuNguyen", "Visible item count: " + visibleItemCount);
			Log.d("ThuNguyen", "Total item: " + totalItemCount);
