...
import com.omebee.android.layers.ui.fragments.MultisizeProductsLauncherFragment;
 ...
 */
public class MultisizeProductsLauncherActivity extends BaseActivity implements IProductsLauncherView, IProductSearchView, SearchView.OnQueryTextListener, AdapterView.OnItemClickListener{
    private ProductsLauncherPresenterImpl mProductsLauncherPresenter;
    private MultisizeProductsLauncherFragment mProductsLauncherFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multisize_products_launcher);

        // Initialize the product launcher fragment
        mProductsLauncherPresenter = new ProductsLauncherPresenterImpl(this);
        mProductsLauncherFragment = new MultisizeProductsLauncherFragment();
        mProductsLauncherFragment = (MultisizeProductsLauncherFragment) getFragmentManager().findFragmentById(R.id.productsLauncherFragment);
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(position == mMenuTitles.length - 1){ // The last item
                // Go to mix layout
                Intent intent = new Intent(MultisizeProductsLauncherActivity.this, MixDemoActivity.class);
